...
#include "tool.h"
static unsigned char IntToBCD(unsigned char intdat);
...
static unsigned char IntToBCD(unsigned char intdat) //十进制转BCD
{
...
void bsp_ds1302_init(void)
{
    ...
    write_1302(0x80, 0x00);   	//时钟启动
	//write_1302(0x90,0xa9);		//涓流充电
